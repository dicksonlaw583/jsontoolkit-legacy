...
assert_equal(json_unset(-1, Array("a", "A")), 0, "9.1a (alt): Failed to handle nonsense!");
assert_equal(json_unset("nonsense", 2, Array("A")), 0, "9.1b (alt): Failed to handle nonsense!");
...
assert_equal(json_unset(fixture, Array("doo")), -1, "9.2.1.3 (alt): Simple bad unset went through!");
...
assert_equal(json_unset(fixture, Array("bar", -5)), -2, "9.2.2.4: Sublist bad unset went through!");
assert_equal(json_unset(fixture, Array("bar", -2)), 1, "9.2.2.5a: Sublist unset failed!");
...
assert_equal(json_unset(fixture, Array("baz", "d")), 1, "9.2.3.4b: Submap unset failed!");
...
assert_equal(json_unset(fixture, Array("goo", -10)), -2, "9.2.4a (alt): Failed to handle overshot path!");
assert_equal(json_unset(fixture, Array("goo"), Array("over")), -2, "9.2.4b (alt): Failed to handle overshot path!");
...
assert_equal(json_unset(fixture, Array(-1)), 1, "9.3.1.4a: Simple unset failed!");
...
assert_equal(json_unset(fixture, Array(1, -2)), 1, "9.3.2.4a: Sublist unset failed!");
...
assert_equal(json_unset(fixture, Array(-1, "F")), 1, "9.3.3.4b: Submap unset failed!");
...
assert_equal(json_unset(fixture, Array(0, -7)), -2, "9.3.4a (alt): Failed to handle overshot path!");
assert_equal(json_unset(fixture, Array(0), Array("overshoot")), -2, "9.3.4b (alt): Failed to handle overshot path!");
