...
assert_equal(json_insert_nested(-1, Array("a"), filling_map), 0, "8.1.1 (alt): Failed nonsense test!");
assert_equal(json_insert_nested("nonsense", Array(2), filling_list), 0, "8.1.2 (alt): Failed nonsense test!");
...
assert_equal(json_insert_nested(fixture, Array("foo", "waahoo"), filling_map), -2, "8.2.1a (alt): Failed to handle overshot path!");
assert_equal(json_insert_nested(fixture, Array("foo", "waahoo"), filling_list), -2, "8.2.1b (alt): Failed to handle overshot path!");
assert_equal(json_insert_nested(fixture, Array("foo", -2), filling_map), -2, "8.2.1c (alt): Failed to handle overshot path!");
assert_equal(json_insert_nested(fixture, Array("foo", -1), filling_list), -2, "8.2.1d (alt): Failed to handle overshot path!");
...
assert_equal(json_insert_nested(fixture, Array("BAR"), filling_list2), 1, "8.2.2.2a: Sublist insert-nest failed!");
...
assert_equal(json_insert_nested(fixture, Array(0, "waahoo"), filling_map), -2, "8.3.1a (alt): Failed to handle overshot path!");
assert_equal(json_insert_nested(fixture, Array(0, "waahoo"), filling_list), -2, "8.3.1b (alt): Failed to handle overshot path!");
assert_equal(json_insert_nested(fixture, Array(0, -1), filling_map), -2, "8.3.1c (alt): Failed to handle overshot path!");
assert_equal(json_insert_nested(fixture, Array(0, -1), filling_list), -2, "8.3.1d (alt): Failed to handle overshot path!");
...
assert_equal(json_insert_nested(fixture, Array(-1), filling_list2), 1, "8.3.2.2a: Sublist insert-nest failed!");
...
assert_equal(json_insert_nested(fixture, Array(-1), filling_map2), 1, "8.3.3.2a: Submap insert-nest failed!");
