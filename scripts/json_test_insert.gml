...
assert_equal(json_insert(fixture, Array("hoo"), "HOO"), 1, "7.2.1.4b: Simple insert failed!");
...
assert_equal(json_insert(fixture, Array("bar", -1), "C"), 1, "7.2.2.3a: Sublist insert failed!");
...
assert_equal(json_insert(fixture, "bar", Array(undefined), "d"), 1, "7.2.2.4a: Sublist insert failed!");
...
assert_equal(json_insert(fixture, Array("baz", "L"), "lambda"), 1, "7.2.3.4b: Submap insert failed!");
...
assert_equal(json_insert(fixture, Array("foo", 0), "overshoot"), -2, "7.2.4.1 (alt 1): Failed to handle overshot path!");
assert_equal(json_insert(fixture, "foo", Array(0), "overshoot"), -2, "7.2.4.1 (alt 2): Failed to handle overshot path!");
...
assert_equal(json_insert(fixture, Array(undefined), "joo"), 1, "7.3.1.3a: Simple insert failed!");
...
assert_equal(json_insert(fixture, Array(-6, -1), "C"), 1, "7.3.2.3a: Sublist insert failed!");
assert_equal(json_insert(fixture, 1, Array(undefined), "d"), 1, "7.3.2.3b: Sublist insert failed!");
...
assert_equal(json_insert(fixture, Array(-5, "L"), "ELL"), 1, "7.3.3.3a: Submap insert failed!");
...
assert_equal(json_insert(fixture, Array(0, 0), "overshoot"), -2, "7.3.4.1 (alt): Failed to handle overshot path!");
