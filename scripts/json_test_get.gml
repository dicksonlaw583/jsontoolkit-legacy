...
assert_equal(json_get(fixture, Array("foo")), "FOO", "3.2.2.1 (alt): Should fetch simple value from array path!");
assert_isnt_defined(json_get(fixture, Array("doo")), "3.2.2.2 (alt): Should handle simple value that doesn't exist from array path!");
...
assert_equal(json_get(fixture, Array("bar", 0)), "a", "3.2.3.1 (alt): Should fetch simple value from array path from sublist!");
assert_equal(json_get(fixture, Array("bar", 1)), "b", "3.2.3.2 (alt): Should fetch simple value from array path from sublist!");
assert_equal(json_get(fixture, Array("bar", 2)), "c", "3.2.3.3 (alt): Should fetch simple value from array path from sublist!");
assert_isnt_defined(json_get(fixture, Array("bar", 3)), "3.2.3.4 (alt): Should handle simple value from array path from sublist that doesn't exist!");
assert_equal(json_get(fixture, Array("bar", -3)), "a", "3.2.3.5 (alt): Should fetch simple value from array path from sublist with negative indexing!");
assert_equal(json_get(fixture, Array("bar", -2)), "b", "3.2.3.6 (alt): Should fetch simple value from array path from sublist with negative indexing!");
assert_equal(json_get(fixture, Array("bar", -1)), "c", "3.2.3.7 (alt): Should fetch simple value from array path from sublist with negative indexing!");
...
assert_equal(json_get(fixture, Array("baz", "d")), "e", "3.2.4.1 (alt): Should fetch simple value from submap!");
assert_isnt_defined(json_get(fixture, Array("baz", "k")), "3.2.4.2 (alt): Should handle simple value from submap that doesn't exist!");

// 3.2.5: Shouldn't choke on overshot paths
assert_isnt_defined(json_get(fixture, "foo", 0), "3.2.5.1: Should handle overshot path!");
assert_isnt_defined(json_get(fixture, Array("foo", 0)), "3.2.5.1 (alt 1): Should handle overshot path!");
assert_isnt_defined(json_get(fixture, "foo", Array(0)), "3.2.5.1 (alt 2): Should handle overshot path!");
...
assert_equal(json_get(fixture, Array(0)), "foo", "3.3.2.1 (alt): Should fetch simple value!");
assert_isnt_defined(json_get(fixture, Array(5)), "3.3.2.2 (alt): Should handle simple value that doesn't exist!");
assert_equal(json_get(fixture, Array(-3)), "foo", "3.3.2.3 (alt): Should fetch simple value with negative index!");
...
assert_equal(json_get(fixture, Array(-2), -3), "a", "3.3.3.9 (alt): Should fetch simple value from sublist!");
assert_equal(json_get(fixture, -2, Array(-2)), "b", "3.3.3.10 (alt): Should fetch simple value from sublist!");
assert_equal(json_get(fixture, Array(-2, -1)), "c", "3.3.3.11 (alt): Should fetch simple value from sublist!");
assert_isnt_defined(json_get(fixture, Array(-2, -4)), "3.3.3.12 (alt): Should handle simple value from sublist that doesn't exist!");
...
assert_equal(json_get(fixture, Array(-1, "d")), "e", "3.3.4.3 (alt): Should fetch simple value from submap!");
assert_isnt_defined(json_get(fixture, Array(2), "k"), "3.3.4.1 (alt): Should handle simple value from submap that doesn't exist!");

// 3.3.5: Shouldn't choke on overshot paths
assert_isnt_defined(json_get(fixture, 0, 0), "3.3.5.1: Should handle overshot path!");
assert_isnt_defined(json_get(fixture, Array(0, -5)), "3.3.5.2: Should handle overshot path!");
