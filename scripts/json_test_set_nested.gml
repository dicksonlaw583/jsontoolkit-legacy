...
assert_equal(json_set_nested(-1, Array("a"), filling_map), 0, "6.1.1 (alt): Failed nonsense test!");
assert_equal(json_set_nested("nonsense", Array(2), filling_list), 0, "6.1.2 (alt): Failed nonsense test!");
...
assert_equal(json_set_nested(fixture, Array("foo", 0), filling_map), -2, "6.2.1c (alt): Failed to handle overshot path!");
assert_equal(json_set_nested(fixture, Array("foo", 0), filling_list), -2, "6.2.1d (alt): Failed to handle overshot path!");
...
assert_equal(json_set_nested(fixture, Array("BAR"), filling_list2), 1, "6.2.2.2a: Sublist nest failed!");
...
assert_equal(json_set_nested(fixture, Array(0, "waahoo"), filling_list), -2, "6.3.1b (alt): Failed to handle overshot path!");
assert_equal(json_set_nested(fixture, Array(0, 0), filling_map), -2, "6.3.1c (alt): Failed to handle overshot path!");
...
assert_equal(json_set_nested(fixture, Array(-2), filling_list2), 1, "6.3.2.2a: Sublist nest failed!");
...
assert_equal(json_set_nested(fixture, Array(-1), filling_map2), 1, "6.3.3.2a: Submap nest failed!");
