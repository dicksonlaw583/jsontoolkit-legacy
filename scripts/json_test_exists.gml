...
assert_equal(json_exists(-1, Array("3", -2)), 0, "4.1.1c: Didn't detect missing top layer!");
...
assert_equal(json_exists(fixture, Array("foo")), 1, "4.2.2.1 (alt): Didn't detect simple value!");
assert_equal(json_exists(fixture, Array("doo")), -1, "4.2.2.2 (alt): Didn't detect missing simple value!");
...
assert_equal(json_exists(fixture, Array("bar", -3)), 1, "4.2.3.7 (alt): Didn't detect sublist value!");
assert_equal(json_exists(fixture, Array("bar", 3)), -2, "4.2.3.8 (alt): Didn't detect missing sublist value!");
...
assert_equal(json_exists(fixture, Array("baz", "d")), 1, "4.2.4.1 (alt): Didn't detect submap value!");
assert_equal(json_exists(fixture, Array("baz", "k")), -2, "4.2.4.2 (alt): Didn't detect missing submap value!");

// 4.2.5: Shouldn't choke on overshot paths
assert_equal(json_exists(fixture, "foo", 0), -2, "4.2.5.1: Didn't handle overshot path!");
assert_equal(json_exists(fixture, Array("foo", 0)), -2, "4.2.5.2: Didn't handle overshot path!");
...
assert_equal(json_exists(fixture, Array(0)), 1, "4.3.2.1 (alt): Didn't detect simple value!");
assert_equal(json_exists(fixture, Array(5)), -1, "4.3.2.2 (alt): Didn't detect missing simple value!");
...
assert_equal(json_exists(fixture, Array(1, 3)), -2, "4.3.3.4 (alt): Didn't detect missing sublist value!");
assert_equal(json_exists(fixture, -2, Array(-1)), 1, "4.3.3.5 (alt): Didn't detect sublist value!");
...
assert_equal(json_exists(fixture, Array(2, "d")), 1, "4.3.4.1 (alt): Didn't detect submap value!");
assert_equal(json_exists(fixture, Array(2, "k")), -2, "4.3.4.2 (alt): Didn't detect missing submap value!");

// 4.3.5: Shouldn't choke on overshot paths
assert_equal(json_exists(fixture, 0, 0), -2, "4.3.5.1: Didn't handle overshot path!");
assert_equal(json_exists(fixture, Array(-3, 0)), -2, "4.3.5.2: Didn't handle overshot path!");
