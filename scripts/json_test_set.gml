...
assert_equal(json_set(-1, Array("a"), "A"), 0, "5.1.1 (alt): Failed nonsense test!");
assert_equal(json_set("nonsense", Array(2), "A"), 0, "5.1.2 (alt): Failed nonsense test!");
...
assert_equal(json_set(fixture, Array("bar", -1), "epsilon"), 1, "5.2.2.4a: Sublist set failed!");
...
assert_equal(json_set(fixture, Array("baz", "L"), "lambda"), 1, "5.2.3.4a: Submap set failed!");
...
assert_equal(json_set(fixture, Array("foo", 0), "overshoot"), -2, "5.2.4.1 (alt): Failed to handle overshot path!");
...
assert_equal(json_set(fixture, Array(-3, -2), "C"), 1, "5.3.2.2g: Sublist set failed!");
...
assert_equal(json_set(fixture, Array(-2, "L"), "ELL"), 1, "5.3.3.3a: Submap set failed!");
...
assert_equal(json_set(fixture, Array(0, 0), "overshoot"), -2, "5.3.4.1 (alt): Failed to handle overshot path!");
